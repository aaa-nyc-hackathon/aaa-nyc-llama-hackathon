...
def track_and_draw_on_first_frame(
    ...
    p0 = cv.goodFeaturesToTrack(image=first_gray, mask=mask, **feature_params)
    ...
    p1, st, err = cv.calcOpticalFlowPyrLK(
        first_gray, second_gray, p0, None, **lk_params
    )
    ...
    while True:
        ...
        p1_new, st_new, err_new = cv.calcOpticalFlowPyrLK(
            prev_gray, frame_gray, prev_pt, None, **lk_params
        )
